...
new NewQuestion('devilsnare', 'You walk through the dark and damp Forbidden Forest when vines start to wrap around your ankles causing you to stumble. As you fall, the snake-like tendrils wrap even tighter and move up your legs. Do you:', '../images/devils_snare.jpg', 'Struggle and pull your legs free.', 'death', 'Point your wand at the vines and yell, "Incendio!!"', 'fluffy');
new NewQuestion('fluffy', 'Continuing along the path, you come across a giant three-headed dog guarding a forked intersection. It gets up lazily as three massive heads turn to glare at you with drool leaking out of three sets of teeth. Do you:', '../images/fluffy.png', 'Pull out the flute tucked in your robe and play an improvised song.', 'potions', 'Run! Are you kidding me!? You don\'t want to become dinner!', 'death');
new NewQuestion('potions', 'Ahead of you are seven bottles of different sizes and colors in row on a large tree stump. A sign next to the stump reads, "Drink one to continue on your journey. Warning: May be hazardous to health. Choose wisely." Do you:', '../images/potions.jpg', 'Drink the smallest bottle in the middle.', 'the ghost', 'Drink the round red bottle on the left.', 'death');
new NewQuestion('the ghost', 'An insubstantial ghost of a woodsman with a grisly chest injury sends chills down your spine. As you shudder and hurry by, he wheezes out behind you "You.. look lost... to get out of here head north... and remember, *cough hack* .. remember that moss always grows on the north side of a tree. More access to sunlight in these here woods." Continuing on, the path stops at the trunk of a large tree, with trails leading left and right. Sure enough, there is moss growing on the left side of its trunk. Do you:', '../images/myrtle.jpg', 'Take the trail on the left.', 'the lantern', 'Take the trail on the right.', 'death');
new NewQuestion('the lantern', 'The earth under your feet is getting squishy and you splash through some shallow muddy puddles. The smell of dank water lingers on the air. 20 yards ahead of you is a small wooden foot bridge. On the other side of the bride, the glow of a lantern hangs in the mist. A voice from that direction says, "Beware of sinkholes in the marsh." Do you:', '../images/dark_forest.jpg', 'Cross the bridge.', 'death', 'Walk around the bridge.', 'sick');
new NewQuestion('sick', 'After some time passes you aren\'t feeling so good. A worrying feeling at the pit of your stomach tells you that you may be poisoned. Do you:', '../images/Mandrake.png', 'Drink a potion brewed of fluxweed, knotgrass, and powdered Bicorn horn.', 'death', 'Swallow a bezoar.', 'hippogriff');
new NewQuestion('hippogriff', 'You feel a gust of strong wind behind your back and it is a hippogriff. Do you bow or run?', '../images/hippogriff.jpg', 'You bow.', 'spiders', 'You run.', 'death');
new NewQuestion('spiders', 'You are surrounded by spiders. Do you step on them or hold them?', '../images/spiders.jpg', 'Hold them.', 'death', 'Step on them.', 'centaur');
new NewQuestion('centaur', 'A centaur is walking towards you. Do you:', '../images/Centaur.jpg', 'Walk towards the centaur and greet it.', 'fork', 'Turn your back and run.', 'death');
new NewQuestion('fork', 'After greeting the centaur, you continue on your path. You come to a fork in the road.', '../images/fork.png', 'Left path.', 'death', 'Right path.', 'house');
new NewQuestion('house', 'You walk along the path and the sorting hat appears, "Which house would like me to sort you into?"', '../images/house.jpg', 'Hufflepuff and Ravenclaw', 'success', 'Gryffindor and Slytherin', 'success');
